  ...
  return(
    <section>
     <div className={Styles.center}>
       ...
       <p>We are connected with various Members of Parliament, Civil Services officers and professors who guide the students towards a better path. </p>
       <p>Since theoretical knowledge is not enough for a better learning experience, Unnati organises various events and seminars for the upliftment of young generation. To provide exposure and experience in different fields, Unnati also provides a platform for internship opportunities.</p>
        </article>
      </div>
    </section>
  )
